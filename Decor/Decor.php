...
<body>
        ...
        <div class="containerSubcategorii">
            <?php
                ...
                if($eroareLaConectare==false)
                {
                    ...
                    afisareSubcategorii($conn, 'decor');
                }
            ?>
        </div>
    ...
    <script>
        ...
        setareIdButon(0, "butonDecoratiuniGradina");
        setareIdButon(1, "butonDecoratiuniInterior");
        setareIdButon(2, "butonOglinzi");
        setareIdButon(3, "butonTablouri");
        setareIdButon(4, "butonTapete");

        setareDestinatieLinkuriButon("butonDecoratiuniGradina", "../Decor/DecoratiuniGradina.php");
        setareDestinatieLinkuriButon("butonDecoratiuniInterior", "../Decor/Decoratiuni.php");
        setareDestinatieLinkuriButon("butonOglinzi", "../Decor/Oglinzi.php");
        setareDestinatieLinkuriButon("butonTablouri", "../Decor/Tablouri.php");
        setareDestinatieLinkuriButon("butonTapete", "../Decor/Tapete.php");
    </script>
</body>
</html>