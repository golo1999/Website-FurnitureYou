...
<body>
        ...
        <div class="containerSubcategorii">
            <?php
                ...
                if($eroareLaConectare==false)
                {
                    ...
                    afisareSubcategorii($conn, 'iluminat');
                }
            ?>
        </div>
    ...
    <script>
        ...
        setareIdButon(0, "butonAplice");
        setareIdButon(1, "butonLuminiGradina");
        setareIdButon(2, "butonLustrePlafoniere");
        setareIdButon(3, "butonVeiozeLampadare");

        setareDestinatieLinkuriButon("butonAplice", "../Iluminat/ApliceDePerete.php");
        setareDestinatieLinkuriButon("butonLuminiGradina", "../Iluminat/LuminiGradina.php");
        setareDestinatieLinkuriButon("butonLustrePlafoniere", "../Iluminat/LustrePlafoniere.php");
        setareDestinatieLinkuriButon("butonVeiozeLampadare", "../Iluminat/VeiozeLampadare.php");
    </script>
</body>
</html>